...
const classList = [
    ...
    name: 'Cycling',
    type: 'bike Ride',
    description: 'A high-energy indoor cycling class designed to improve endurance, burn calories, and strengthen your lower body. Ride to the rhythm of motivating music with guided intervals, climbs, and sprints.',
    img: cycling
  },
   {
    name: 'Boxing',
  ...
  },
   {
    ...
    description: 'A balanced flow to improve flexibility, focus, and mind-body connection.',
    img: yoga
  },
   {
    name: 'HIIT',
    type: 'High Intensity interval training',
    description: 'Fast-paced intervals that build strength, boost endurance, and torch calories.',
    img: hiit
  },
   {
    name: 'Strength Training',
    type: 'resistance based weight training',
    description: ' Full-body training with weights to build muscle and increase power.',
    img: strength
  },
]
